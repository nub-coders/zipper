...
TEXTS = {
    "en": {
        ...
        "lang_btn_fa": "🇮🇷 فارسی",
        "start_msg": (
            f"<h1>{EmojiTag.ARCHIVE} File Zipper Bot</h1>\n"
            f"<blockquote>High-performance file compression, archive encryption, and cloud transfers directly on Telegram.</blockquote>\n\n"
            f"<b>{EmojiTag.STAR} Core Capabilities:</b>\n"
            ...
            f"<b>{EmojiTag.INFO} Storage Limits:</b>\n"
    ...
    "fa": {
        ...
        "lang_btn_fa": "🇮🇷 فارسی",
        "start_msg": (
            f"<h1>{EmojiTag.ARCHIVE} ربات فشرده‌ساز فایل</h1>\n"
            f"<blockquote>فشرده‌سازی سریع فایل‌ها، ساخت آرشیو‌های رمزگذاری شده و انتقال مستقیم ابری در تلگرام.</blockquote>\n\n"
            f"<b>{EmojiTag.STAR} امکانات اصلی:</b>\n"
            ...
            f"<b>{EmojiTag.INFO} محدودیت‌های ذخیره‌سازی:</b>\n"
